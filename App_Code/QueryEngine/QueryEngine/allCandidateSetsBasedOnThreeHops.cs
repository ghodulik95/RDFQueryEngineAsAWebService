...
{
    public class allCandidateSetsBasedOnThreeHops
    {
        public allCandidateSetsBasedOnThreeHops()
        {
        }
        ...
        public static Dictionary<int, List<int>> generateAllCandidate(DataTable queryGraph, Dictionary<int, string> queryIDWithKeyword, Dictionary<int, List<NBEntry>> NBindex, Dictionary<string, List<int>> intervalForString)
        {
            ...
            foreach (KeyValuePair<int, string> pair in queryIDWithKeyword)
            {
                ...
                candidateSetforQueryID = candidateGenerationBasedOnThreeHops.generateCandidate(queryGraph, queryID, queryKeyword, NBindex, intervalForString);
